...
class CreateUser
{
     ...
     * @return void
     */
    public function handle(EventsNotificationUser $event)
    {
        ...
        NotificationUser::where('notifications_id', $notification->id)->where('user_id', $event->user->id)->update(['notification_status' => 'on']);
    }
}
