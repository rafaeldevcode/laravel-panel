<article class='p-3 m-3 bg-cm-grey shadow'>
    <div>
        ...
        <h4>Política de Cookies {{ $settings->site_name }}</h4>
        ...
        <ul class='cm-list'>
            <li>
                <b class='text-color-main'>Cookies relacionados à conta</b>
            ...
            <li>
                <b class='text-color-main'>Cookies relacionados ao login</b>
            ...
            <li>
                <b class='text-color-main'>Cookies relacionados a pesquisas</b>

                <p>Periodicamente, oferecemos pesquisas e questionários para fornecer informações interessantes, ferramentas úteis ou para entender nossa base de usuários com mais precisão. Essas pesquisas podem usar cookies para lembrar quem já participou numa pesquisa ou para fornecer resultados precisos após a alteração das páginas.</p>
            </li>

            <li>
                <b class='text-color-main'>Cookies relacionados a formulários</b>
            ...
            <li>
                <b class='text-color-main'>Cookies de preferências do site</b>
        ...
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o <b class='text-color-main'>{{ $settings->site_name }}</b> oferece no site e com caráter enunciativo, mas não limitativo:</p>
        ...
        <ul class='cm-list'>
            ...
            <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do <b class='text-color-main'>{{ $settings->site_name }}</b>, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
        </ul>
